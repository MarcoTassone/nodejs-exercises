...
const db = pgPromise()("postgres://postgres:postgres@localhost:5432/exercise");
...
const getOneById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const planets = yield db.oneOrNone(`SELECT * FROM planets WHERE id=$1;`, Number(id));
    res.status(200).json(planets);
});
...
const deleteById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    yield db.none(`DELET FROM planets WHERE id=$1`, Number(id));
...
export { getAll, getOneById, create, updateById, deleteById, uploadImage };
